...
> **CNN 기법**을 사용해 사용자가 사진을 입력하면 사전에 모델이 학습한 연예인 범주 중 하나를 출력해주는 서비스입니다
...
> 모델은 사전학습된 **VGG16 모델**을 가져와서 전이학습시키는 방식으로 진행하였습니다.
...
> 구글에 있는 연예인 이미지를 연예인 1명당 200장씩 크롤링하여 수집하였습니다.
...
> 전처리 과정에서 많은 이미지 데이터들이 소실되었기 때문에 이미지 보강을 해주었습니다

<br>

## 4. 배포하기

> AWS에서 인스턴스를 생성하여 배포하였습니다.
